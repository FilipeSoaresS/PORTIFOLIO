function Sobre () {
    ...
    <div>
        ...
        <div className='habilidades'>
            <p> • Estudando atualmente desenvolvimento em front-end(vue.js, react.js, angular.js).</p>
            <p> • Fluente em inglês e português, com conhecimento basico também em francês.</p>
            <p> • Comunicativo, sociável e curioso por natureza! Gosto de me desafiar e superar minhas limitações</p>
            <p>• Boas praticas de programação, organização</p>
        </div>
    </div>
    )
};
